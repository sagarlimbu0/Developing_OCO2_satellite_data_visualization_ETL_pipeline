...
def extract_data(year: int ,month: int, username_: str, password_: str):
    ...
    lite_file= '/OCO2_GEOS_L3CO2_DAY.10r/' + str(year)
...
extract_data_= PythonOperator(
    ...
    op_kwargs={
        'year': 2021,
        'month': 10,
        'username_': os.environ.get("earthdata_username"),
        'password_': os.environ.get("earthdata_password"),
